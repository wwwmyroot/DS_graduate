...
# dataset_bp = pd.read_excel("/content/dataset/in_x_bp.xlsx", engine="xlrd")
# dataset_nup = pd.read_excel("/content/dataset/in_x_nup.xlsx", engine="xlrd")

# dataset_bp = pd.DataFrame(pd.read_csv("/content/dataset/in_x_bp.csv"))
# dataset_nup = pd.DataFrame(pd.read_csv("/content/dataset/in_x_nup.csv"))
...
dataset_bp = pd.DataFrame(pd.read_csv("/content/in_c2_X_bp.csv"))
dataset_nup = pd.DataFrame(pd.read_csv("/content/in_c2_X_nup.csv"))
...
# print(f'------------ bp widgets ------------')
# profile_bp.to_widgets()
# print(f'------------ nup widgets ------------')
# profile_nup.to_widgets()
