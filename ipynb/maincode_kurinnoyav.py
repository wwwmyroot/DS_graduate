...
! mkdir /content/model_matrix
! ls -lA | grep "model_matrix"
best_model.save('model_matrix', '/content/model_matrix/')
...
nn_model = keras.models.load_model('/content/model_matrix/')
scaler_x = load('/content/minmax_scl_x.pkl')
scaler_y = load('/content/minmax_scl_y.pkl')
...
def app_model():
    # Загружаем модель и масштабаторы
    nn_model = load_model('/content/model_matrix/')
    scaler_x = load('/content/minmax_scl_x.pkl')
    scaler_y = load('/content/minmax_scl_y.pkl')
