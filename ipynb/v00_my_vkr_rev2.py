...
from pandas import DataFrame                            # для работы с датафреймами
...
import tensorflow.keras as keras                        # для создания нейронной сети
...
import flask                                            # для создания приложения 
...
# Загрузим характеристики базальтопластика - файл "X_bp.xlsx" в корень дирректории /content
...
# 1.2. RobustScaler()
# Cтандартизация признака, однако преобразование происходит с помощью персантилей, тем самым снижается эффект выбросов
